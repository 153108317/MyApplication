...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public interface PageTabListener {
        public void onPageTabItemClick(int position, View view);
    }
    ...
    private PageTabListener mPageTabListener;
    ...
    private int unSelectTextsize = 12;
...
//				TypedValue.COMPLEX_UNIT_DIP, dividerWidth, dm);
        ...
        dividerPadding = a.getDimensionPixelSize(
                ...
                dividerPadding);
        selectTextSize = a.getDimensionPixelSize(
                R.styleable.PagerSlidingTabStrip1_zmsSelecteTextTabSize,
                selectTextSize);
        unSelectTextsize = a.getDimensionPixelSize(
                R.styleable.PagerSlidingTabStrip1_zmsUnSelecteTextTabSize,
                unSelectTextsize);
        ...
        roundBorder = a.getBoolean(
                R.styleable.PagerSlidingTabStrip1_zmsRoundTab, roundBorder);

        selectedTextColor = a.getColor(
                R.styleable.PagerSlidingTabStrip1_zmsSelectedTabTextColor,
                selectedTextColor);
        tabTextColor = a.getColor(R.styleable.PagerSlidingTabStrip1_zmsUnSelectedTabTextColor, tabTextColor);
    ...
    public void setPageTabClickListener(PageTabListener listener) {
        this.mPageTabListener = listener;
    }
...
//        if (pager.getAdapter() instanceof BaseTabFragmentPagerAdapter) {
//            tabCount = ((BaseTabFragmentPagerAdapter) pager.getAdapter())
//                    .getTabCount();
//        } else
        {
    ...
    private void updateTabStyles() {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (v instanceof TextView) {
                ...
                tab.setTextSize(TypedValue.COMPLEX_UNIT_PX, unSelectTextsize);
                ...
                if (i == selectedPosition) {
                    ...
                    if (roundBorder) {
//                        if (i == 0) {
//                            tab.setBackgroundResource(R.drawable.shape_food_mgr_titile_tab_left);
//                        } else if (i == tabCount - 1) {
//                            tab.setBackgroundResource(R.drawable.shape_food_mgr_titile_tab_right);
//                        } else {
//                            tab.setBackgroundResource(R.drawable.shape_food_mgr_titile_tab_middle);
//                        }
                    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(lineLeft + marginH, height - indicatorHeight,
                lineRight - marginH, height, rectPaint);
